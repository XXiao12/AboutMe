        ...
        <div className="home">
          <div className="home__container">
            <div className="home__container--content">
              <p className="home__private"><span className="color"><FontAwesomeIcon icon={faUserShield} /> Private Projects</span>There are ongoing projects that are not allowed to be displayed on the internet. I would gladly show these projects in an in-person meeting or interview.<Button
                  component={Process}
